...
function main() {
  if (!fs.existsSync(IN_DIR)) {
    console.error(`No vendored splash data at ${IN_DIR}.`);
    process.exit(1);
  }
  ...
  out += '// Source: vendored 20x20 pixel-art frames under tools/claudepix_data/.\n';
  out += '// Do not edit by hand — re-run tools/convert_to_c.js to refresh.\n';
  out += '// ============================================================\n';
